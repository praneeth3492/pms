    ...
    $(document).on('ready', function() {
        ...
        /* ==================================================
         ...
         $('.advisor-carousel').owlCarousel({
            ...
            $('.advisor-carousel').trigger('stop.owl.autoplay');
        }).on('mouseleave', function() {
            $('.advisor-carousel').trigger('play.owl.autoplay');
        });

        $('.advisor-carousel').on('touchstart', function() {
        ...
        /* ==================================================
         ...
         $('.clients-review-carousel').owlCarousel({
            ...
            dots: false,
            autoplay: true,
            autoplayTimeout: 2500, // Adjust the speed to 3 seconds (3000 milliseconds)
            responsive: {
                0: {
                    items: 1
                },
