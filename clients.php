        ...
        <div class="main">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td><a href="add_fields.php?project_id=' . $row['project_id'] . '" class="btn btn-primary">Edit Fields</a>
                    <a href="view_performance.php?client_id=' . $row['project_id'] . '" class="btn btn-primary">View Project</a></td>';
                    echo "</tr>";
                }
            } else {
